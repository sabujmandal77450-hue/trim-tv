...
import { getApp, getId, onIdChange, getInstallations, makeIDBAvailable } from '@react-native-firebase/app/dist/module/internal/web/firebaseInstallations';
import { getItem, setItem, isMemoryStorage } from '@react-native-firebase/app/dist/module/internal/asyncStorage';
...
class AnalyticsApi {
  ...
  _startQueueProcessing() {
    ...
    this.started = true;
    this.queueTimer = setInterval(() => this._processQueue().catch(console.error), this.queueInterval);
  }
