...
export declare const getChangedFiles: (directory: string, revision: string | null, _staged?: boolean) => Promise<string[]>;
export declare const getUnstagedChangedFiles: () => never[];
export declare const stageFile: (directory: string, file: string) => import("tinyexec").Result;
