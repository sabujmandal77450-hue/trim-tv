 ...
 */
export type RingMuteSwitchEventCallback = (status: RingMuteSwitchStatus) => void;
/**
 ...
 * @export
 */
export type AVAudioSessionMode = 'Default' | 'VoiceChat' | 'VideoChat' | 'GameChat' | 'VideoRecording' | 'Measurement' | 'MoviePlayback' | 'SpokenAudio';
/**
 * Types of volume on Android.
 * @export
 */
export type AndroidVolumeTypes = 'music' | 'call' | 'system' | 'ring' | 'alarm' | 'notification';
/**
