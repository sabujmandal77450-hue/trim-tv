...
const AnimatedVideoPlayer = props => {
  ...
  const [_resizeMode, setResizeMode] = useState(ResizeMode.CONTAIN);
  ...
  const [_playbackRate, setPlaybackRate] = useState(rate);
  ...
  const toggleControls = useCallback(() => setShowControls(prevState => alwaysShowControls || !prevState), [alwaysShowControls]);
  const toggleTimer = useCallback(() => setShowTimeRemaining(prevState => !prevState), []);
  ...
  const _onProgress = useCallback(data => {
    setLoading(false);
  ...
  const _onPlaybackRateChange = useCallback(playBack => {
  ...
  const setSeekerPosition = useCallback((position = 0) => {
  ...
  const setVolumePosition = useCallback((position = 0) => {
  ...
  const updateSeekerPositionRef = useRef(null);
  useEffect(() => {
  ...
  const forward = useCallback(time => {
  ...
  return /*#__PURE__*/React.createElement(PlatformSupport, {
    ...
    source: source,
    onBuffer: onBuffer
  })), /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Error, {
    error: error
  }), !hideAllControlls && /*#__PURE__*/React.createElement(React.Fragment, null, !disableOverlay && /*#__PURE__*/React.createElement(Overlay, {
  ...
  }), /*#__PURE__*/React.createElement(Gestures, {
    forward: forward,
    rewind: rewind,
    togglePlayPause: togglePlayPause,
