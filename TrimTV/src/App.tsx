...
import {Dimensions, LogBox, Platform, ViewStyle} from 'react-native';
...
import SchoolMode from './screens/settings/SchoolMode';
...
const isLargeScreen = Platform.isTV || Dimensions.get('window').width > 768;
  ...
  function SettingsStackScreen() {
    return (
      <SettingsStack.Navigator
        ...
        <SettingsStack.Screen name="SchoolMode" component={SchoolMode} />
        <SettingsStack.Screen
